...
const app = createApp({
    ...
    setup() {
        ...
        const appCtx = {
            ...
            fetchDisciplineReport, fetchDisciplineDrafts, fetchDisciplinePresets, applyDisciplinePreset, refreshDiscipline, openPolicyDialog, cancelPolicy, savePolicy, greeReducePct, createDraftsFromReport,
